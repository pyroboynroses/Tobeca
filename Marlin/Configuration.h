...
#define INVERT_X_DIR true    // set to true for Tobeca Precision only
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {67.005, 67.005, 2560,152}    // from T0-0 to TO-0 and TP-001 (HTD3M)
