...
#if (THERMISTORHEATER_0 == 11) || (THERMISTORHEATER_1 == 11)  || (THERMISTORHEATER_2 == 11) || (THERMISTORBED == 11) //new squeezewear thermistor
#define NUMTEMPS_1 56
//short temptable[NUMTEMPS][1] = {
